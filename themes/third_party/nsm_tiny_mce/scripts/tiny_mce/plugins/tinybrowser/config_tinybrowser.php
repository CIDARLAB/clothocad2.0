...
$_SESSION['tinybrowser']['path']['root'] = '/images/uploads/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/images/uploads/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$_SESSION['tinybrowser']['path']['media'] = '/images/uploads/'; // Media files location
$_SESSION['tinybrowser']['path']['file']  = '/images/uploads/'; // Other files location
